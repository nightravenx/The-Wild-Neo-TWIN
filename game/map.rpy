...
define bgNameList = ["portal", "surabaya", "borobudur"]
...
label mapStart:
    ...
    call grindTypeRand from _call_grindTypeRand
...
screen buttonMap:
    ...
    button:
        xalign 0.73 yalign 0.0
        text "Upgrade Gauntlet" xalign 0.5 yalign 0.5 style ("grindArea_font")
        xysize(420,90)
        style "grindArea_button"
        action Hide("buttonMap", transition=dissolve), Call("upstart")
    # imagebutton:
        ...
        vbox:
            ...
            hbox:
                ...
                button:
                    ...
                    xysize(220,80)
                    style "grindArea_button"
                    action Hide("grindAreaPage", transition=dissolve), SetVariable("bgName", bgNameList[1]), SetVariable("tbType", grindType[1]), SetVariable("enemymaxhp", 250), SetVariable("enemycurhp", 250), SetVariable("enemyatk", 150), SetVariable("enemydef", 120), SetVariable("expmulti", 5), SetVariable("enemydefe", grindType[1]), SetVariable("grinding", True), Jump("battle")
            hbox:
                spacing 50

                #Enemy Stats lvl5
                # define enemymaxhp = 300 > 400
                # define enemyatk = 150 > 200
                # define enemydef = 120 > 150
                vbox:
                ...
                button:
                    ...
                    xysize(220,80)
                    style "grindArea_button"
                    action Hide("grindAreaPage", transition=dissolve), SetVariable("bgName", bgNameList[2]), SetVariable("tbType", grindType[2]), SetVariable("enemymaxhp", 400), SetVariable("enemycurhp", 400), SetVariable("enemyatk", 200), SetVariable("enemydef", 150), SetVariable("expmulti", 8), SetVariable("enemydefe", grindType[2]), SetVariable("grinding", True), Jump("battle")
...
label grindTypeRand:
    ...
    $renpy.random.shuffle(bgNameList)
    return
