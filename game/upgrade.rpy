...
default maxBubble_Stream = 50 #Indo
default maxATK = 100
default maxCrit = 100
default tempHp = 200
default tempDef = 100
...
screen upgrade:
    ...
    frame at alpha_dissolve:
        ...
        add "images/UI/Upgrade/atkup.png" zoom 0.8 xalign 0.7 yalign 0.3
        text "ATK: [playeratk]" style "stattext" xalign 0.69 yalign 0.448
        imagebutton:
            auto "images/UI/button/plus2_%s.png" xalign 0.729 yalign 0.22 at pluszoom
            sensitive imagebutton_enabled_state
            action [SetVariable("clickstat", "ATK"), Hide("upgrade"), Call("increase")]

        add "images/UI/Upgrade/critup.png" zoom 0.8 xalign 0.875 yalign 0.3
        text "Crit: [critdmg1]%" style "stattext" xalign 0.854 yalign 0.448
        imagebutton:
...
##################################### Bottom ############################################
        ...
        text "Water: [Bubble_Stream]" style "stattext" xalign 0.857 yalign 0.75
        imagebutton:
...
#####################################Final Button########################################
    ...
    frame at alpha_dissolve:
        ...
        text "Lv: [lvl]" style "aptext" xalign 0.25 yalign 0.5
        text "|" style "aptext" xalign 0.5 yalign 0.5
        text "AP: [curap]" style "aptext" xalign 0.75 yalign 0.5
...
label resetup:
    ...
    $Bubble_Stream = maxBubble_Stream
    $playeratk = maxATK
    $critdmg1 = maxCrit
    $playermaxhp = tempHp
    $playerdef = tempDef
...
label confirmup:
    ...
    $maxBubble_Stream = Bubble_Stream
    $maxATK = playeratk
    $maxCrit = critdmg1
    $ tempHp = playermaxhp
