...
image tb c marah = "Character/tb/common/marah.png"
image tb c senang = "Character/tb/common/senang.png"
...
# shot no 3
    ...
    "Mika mulai menganalisa alat di tangan Time Bandit yang dicurigai sebagai mesin waktu.{w=4}{nw}"
    with Dissolve(0.5)
    $ renpy.pause(0.5, hard=True)
# shot no 4
    scene bg portal
